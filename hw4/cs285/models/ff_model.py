...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        obs_normalized = normalize(obs_unnormalized, obs_mean, obs_std)# TODO(Q1) DONE
        acs_normalized = normalize(acs_unnormalized, acs_mean, acs_std)# TODO(Q1) DONE
        ...
        next_obs_pred = obs_unnormalized + unnormalize(delta_pred_normalized, delta_mean, delta_std) # TODO(Q1) DONE
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        norm_delta_pred = self.forward(obs, acs, obs_mean, obs_std, acs_mean, acs_std, delta_mean, delta_std)[1]
