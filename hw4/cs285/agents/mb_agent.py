...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            low, high = i * num_data_per_ens, (i + 1) * num_data_per_ens
            observations = ob_no[low:high]  # TODO(Q1) DONE
            actions = ac_na[low:high]  # TODO(Q1) DONE
            next_observations = next_ob_no[low:high]  # TODO(Q1) DONE

            # use datapoints to update one of the dyn_models
            model = self.dyn_models[i]  # TODO DONE
